...
namespace UpsideEffects.Editor
{
    public static class UpsideEffectsPrototypeBuilder
    {
        private const string RootFolder = "Assets/_UPSIDE_EFFECTS";
        ...
        private static Material CreateOrUpdateCustomPassMaterial()
        {
            ...
            if (shader == null)
            {
                shader = Shader.Find("Hidden/UPSIDE_EFFECTS/PsychedelicFullScreen");
            }
